...
{{
  config(
    materialized = 'table',
    schema       = 'public',
    alias        = 'gold_energy_prices',
    post_hook    = "create index if not exists idx_gold_period on gold_energy_prices (period)"
  )
}}
